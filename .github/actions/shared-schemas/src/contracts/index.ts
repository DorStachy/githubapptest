...
export interface NormalizedFinding {
  ...
  // Runtime-enriched (set during baseline comparison / suppression / cache)
  isNew?: boolean;
  status?: string;
...
// ── Scanner Job Message (Backend → Scanner Worker) ─────────────────────
...
// ── Scan Processor Message (Scanner Worker → Processor, OR Ingestion → Processor) ──
